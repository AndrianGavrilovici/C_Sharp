namespace ex1
{
	partial class Form1
	{
		...
		private void InitializeComponent() {
			...
			this.radioButton1.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// radioButton2
			// 
			...
			this.radioButton2.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// radioButton3
			// 
			...
			this.radioButton3.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// radioButton4
			// 
			...
			this.radioButton4.Text = "13";
			this.radioButton4.UseVisualStyleBackColor = true;
			this.radioButton4.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// radioButton5
			// 
			this.radioButton5.AutoSize = true;
			this.radioButton5.Location = new System.Drawing.Point(43, 123);
			this.radioButton5.Name = "radioButton5";
			this.radioButton5.Size = new System.Drawing.Size(37, 17);
			this.radioButton5.TabIndex = 0;
			this.radioButton5.Text = "14";
			this.radioButton5.UseVisualStyleBackColor = true;
			this.radioButton5.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// radioButton6
			// 
			this.radioButton6.AutoSize = true;
			this.radioButton6.Location = new System.Drawing.Point(43, 146);
			this.radioButton6.Name = "radioButton6";
			this.radioButton6.Size = new System.Drawing.Size(37, 17);
			this.radioButton6.TabIndex = 0;
			this.radioButton6.Text = "15";
			this.radioButton6.UseVisualStyleBackColor = true;
			this.radioButton6.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// button1
			// 
			...
			this.radioButton7.Location = new System.Drawing.Point(43, 169);
			this.radioButton7.Name = "radioButton7";
			this.radioButton7.Size = new System.Drawing.Size(37, 17);
			this.radioButton7.TabIndex = 0;
			this.radioButton7.Text = "16";
			this.radioButton7.UseVisualStyleBackColor = true;
			this.radioButton7.CheckedChanged += new System.EventHandler(this.Cheched);
			// 
			// Form1
			// 
